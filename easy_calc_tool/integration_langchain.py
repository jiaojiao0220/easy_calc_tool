...
def create_langchain_tools(calc: Optional[EasyCalc] = None) -> List[StructuredTool]:
    ...
    tools.append(
        StructuredTool.from_function(
            func=lambda expression=None, a=None, b=None, operation=None: _arithmetic_wrapper(
                calc, expression, a, b, operation
            ),
            name="calculator",
    ...
    tools.append(
        StructuredTool.from_function(
            func=lambda data, columns=None, operations="mean,sum", group_by=None: _statistics_wrapper(
                calc, data, columns, operations, group_by
            ),
            name="statistics",
    ...
    tools.append(
        StructuredTool.from_function(
            func=lambda data, what=None, columns=None, operations=None, group_by=None: _aggregate_wrapper(
                calc, data, what, columns, operations, group_by
            ),
            name="aggregate",
    ...
    tools.append(
        StructuredTool.from_function(
            func=lambda data, condition, calculate=None, columns=None, operations=None: _filter_calc_wrapper(
                calc, data, condition, calculate, columns, operations
            ),
            name="filter_calc",
    ...
    tools.append(
        StructuredTool.from_function(
            func=lambda data, operation, date_col=None, value_col=None, window=3: _timeseries_wrapper(
                calc, data, operation, date_col, value_col, window
            ),
            name="timeseries",
    ...
    tools.append(
        StructuredTool.from_function(
            func=lambda value, from_unit, to_unit: _unit_convert_wrapper(
                calc, value, from_unit, to_unit
            ),
            name="unit_convert",
    ...
    tools.append(
        StructuredTool.from_function(
            func=lambda data, percentiles="0.25,0.5,0.75", include="all": _describe_wrapper(
                calc, data, percentiles, include
            ),
            name="describe",
    ...
    tools.append(
        StructuredTool.from_function(
            func=lambda data, method="pearson", columns=None: _correlation_wrapper(
                calc, data, method, columns
            ),
            name="correlation",
    ...
    tools.append(
        StructuredTool.from_function(
            func=lambda data, index, values, columns=None, aggfunc="mean", fill_value=0: _pivot_wrapper(
                calc, data, index, values, columns, aggfunc, fill_value
            ),
            name="pivot",
            description="创建数据透视表。",
