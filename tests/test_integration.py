...
class TestEndToEndWorkflows:
    ...
    def test_complete_data_analysis_pipeline(self, calc, sample_data_list):
        ...
        # Step 1: Filter data
        filtered = calc.calculate(
            "filter_calc", sample_data_list, condition="sales > 150"
        )
    ...
    def test_multi_step_calculation_with_cache(self):
        ...
        result1 = calc.calculate(
            "statistics", data, columns="x", operations="sum"
        )
        ...
        assert (
            result1["statistics"]["x"]["sum"]
            == result2["statistics"]["x"]["sum"]
        )
...
class TestEdgeCases:
    ...
    def test_all_same_values(self, calc):
        ...
        result = calc.calculate(
            "statistics", data, columns="value", operations=["std"]
        )
    ...
    def test_negative_values(self, calc):
        ...
        result = calc.calculate(
            "statistics", data, columns="value", operations=["sum", "mean"]
        )
    ...
    def test_decimal_precision(self, calc):
        ...
        result = calc.calculate(
            "statistics", data, columns="value", operations=["mean"]
        )
    ...
    def test_special_characters_in_column_names(self, calc):
        ...
        result = calc.calculate(
            "statistics", data, columns="column-name", operations="sum"
        )
...
class TestLargeDataPerformance:
    ...
    def test_large_dataframe_correlation(self, calc, large_dataframe):
        ...
        result = calc.calculate(
            "correlation", large_dataframe, columns=["value1", "value2"]
        )
...
class TestJSONSerialization:
    ...
    def test_numpy_types_converted(self, calc, sample_dataframe):
        ...
        assert (
            not hasattr(value, "item")
            or callable(getattr(value, "item", None)) is False
        )
...
class TestLangChainIntegration:
    ...
    def test_langchain_import(self):
        ...
        try:
            from easy_calc_tool.integration_langchain import (
                get_langchain_tools,
            )
