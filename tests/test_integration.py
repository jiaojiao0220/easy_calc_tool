...
class TestEndToEndWorkflows:
    ...
    def test_complete_data_analysis_pipeline(self, calc, sample_data_list):
        ...
        # Step 1: Filter data
        filtered = calc.calculate("filter_calc", sample_data_list, condition="sales > 150")
        ...
        stats = calc.calculate(
            "statistics", sample_data_list, columns="sales", operations=["mean", "std"]
        )
    ...
    def test_timeseries_with_statistics(self, calc, timeseries_dataframe):
        ...
        ma_result = calc.calculate(
            "timeseries", timeseries_dataframe, operation="moving_average", window=7
        )
        assert ma_result["operation"] == "moving_average"

        # Calculate statistics on original data
        stats = calc.calculate(
            "statistics", timeseries_dataframe, columns="sales", operations=["mean", "std"]
        )
        assert "statistics" in stats

        # Calculate growth rate
        growth = calc.calculate("timeseries", timeseries_dataframe, operation="growth_rate")
...
class TestEdgeCases:
    ...
    def test_single_row_data(self, calc):
        ...
        data = [{"value": 100}]
        result = calc.calculate(
            "statistics", data, columns="value", operations=["sum", "mean", "std"]
        )
    ...
    def test_all_same_values(self, calc):
        ...
        result = calc.calculate("statistics", data, columns="value", operations=["std"])
        assert result["statistics"]["value"]["std"] == 0

    def test_negative_values(self, calc):
        """Test with negative values."""
        data = [{"value": -10}, {"value": -20}, {"value": -30}]
        result = calc.calculate("statistics", data, columns="value", operations=["sum", "mean"])
    ...
    def test_decimal_precision(self, calc):
        ...
        result = calc.calculate("statistics", data, columns="value", operations=["mean"])
    ...
    def test_special_characters_in_column_names(self, calc):
        ...
        result = calc.calculate("statistics", data, columns="column-name", operations="sum")
...
class TestErrorHandling:
    ...
    def test_invalid_column_name(self, calc, sample_dataframe):
        ...
        result = calc.calculate(
            "statistics", sample_dataframe, columns="nonexistent_column", operations="sum"
        )
        assert result.get("success") is False
    ...
    def test_invalid_operation(self, calc, sample_dataframe):
        ...
        result = calc.calculate(
            "statistics", sample_dataframe, columns="value", operations="invalid_op"
        )
...
class TestLargeDataPerformance:
    ...
    def test_large_dataframe_statistics(self, calc, large_dataframe):
        ...
        result = calc.calculate(
            "statistics", large_dataframe, columns="value1", operations=["sum", "mean"]
        )
        assert "statistics" in result
    ...
    def test_large_dataframe_groupby(self, calc, large_dataframe):
        ...
        result = calc.calculate(
            "statistics", large_dataframe, columns="value1", operations="sum", group_by="group"
        )
    ...
    def test_large_dataframe_correlation(self, calc, large_dataframe):
        ...
        result = calc.calculate("correlation", large_dataframe, columns=["value1", "value2"])
...
class TestJSONSerialization:
    ...
    def test_result_is_json_serializable(self, calc, sample_dataframe):
        ...
        result = calc.calculate(
            "statistics", sample_dataframe, columns="value", operations=["sum", "mean"]
        )
